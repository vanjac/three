...
class TestObject(EditorObject):
    ...
    def __init__(self):
        ...
        c = self.mesh.addVertex(MeshVertex(Vector(-8,  8, -8)))
        d = self.mesh.addVertex(MeshVertex(Vector( 8,  8, -8)))
        e = self.mesh.addVertex(MeshVertex(Vector(-8, -8,  8)))
        f = self.mesh.addVertex(MeshVertex(Vector( 8, -8,  8)))
        g = self.mesh.addVertex(MeshVertex(Vector(-8,  8,  8)))
        h = self.mesh.addVertex(MeshVertex(Vector( 8,  8,  8)))
